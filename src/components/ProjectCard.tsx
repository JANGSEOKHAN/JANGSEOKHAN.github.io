...
const visualNoteHighlights = [
  '공식 홈페이지/브로셔 제공 자료',
  '디지털 트윈 서비스 화면과 엑셈원 모니터링 이미지는 공식 홈페이지 및 브로셔 제공 자료를 활용',
  '보안상 더미데이터로 재구성한 화면',
  '보안상 실제 시스템명, 계정, IP 등은 제거 또는 블러 처리',
  '시스템명, 계정, IP 등은 제거 또는 블러 처리',
  '직접 설계',
  '직접 작업한 아키텍처 이미지는 직접 설계한 사진',
  '직접 수행한 업무 내용을 기반으로 재구성하여 설계/작성',
  '(직접 임시로 재구축한 테스트 화면)',
  '(직접 구성한 더미데이터 화면)',
  '(테스트용 사진)',
      ...
      <div className="project-summary">
        <div>
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <span className="max-w-full break-words rounded-md bg-slate-100 px-2.5 py-1.5 text-xs font-semibold leading-5 text-slate-700 sm:text-[13px] sm:leading-6">{project.period}</span>
            <span className="max-w-full break-words rounded-md bg-signal-green/10 px-2.5 py-1.5 text-xs font-semibold leading-5 text-signal-green sm:text-[13px] sm:leading-6">{project.mainRole}</span>
          </div>
