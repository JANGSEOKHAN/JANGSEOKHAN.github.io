    ...
    <article className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
      <div>
        <div>
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <span className="rounded-md bg-slate-100 px-3 py-1.5 text-xs font-semibold text-slate-700">{project.period}</span>
            <span className="rounded-md bg-signal-green/10 px-3 py-1.5 text-xs font-semibold text-signal-green">{project.mainRole}</span>
          </div>
      ...
      {activeVisual ? (
        <section className="mt-5">
          ...
          {project.visualNote ? (
            <p className="mb-3 rounded-md border border-slate-200 bg-white px-3 py-2 text-xs font-medium leading-5 text-slate-500">
              {project.visualNote}
            </p>
          ) : null}
